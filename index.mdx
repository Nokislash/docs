...
<Card title="Start here" icon="book-bible" color="#df0000" horizontal="false" href="/quickstart" cta="Viens">
...
<Columns cols={2}>
  ...
  <Card title="New Card" icon="sparkles" iconType="sharp-solid" color="#f10000">
...
sign a docs site that looks great and empowers your users.
...
<Card title="See complete examples" icon="stars" href="https://mintlify.com/customers">
  Browse our showcase of exceptional documentation s
</Card>